...
<div id='galeria' style='height:300px;'>
<div id='head3'>
...
<div id ='main'>
	...
	<div class='imagem_galeria' style='padding:10px;float:left;'>
		<div class='del_imagem' style='display:none;position:absolute;'><img src='images/del.png' alt=<?php echo $img->id; ?>/></div>
